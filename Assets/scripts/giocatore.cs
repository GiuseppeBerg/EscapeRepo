...
public class giocatore : MonoBehaviour
{
    ...
    public Canvas img,img2;
    private BitArray explored = new BitArray(2);
    
    public GameObject prefabLibro1, prefablibro2;
    ...
    void Update()
    {
       ...
       RaycastHit hit;
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            else if (objecthit.gameObject.CompareTag("book1"))
            {
                if (modified == false)
                {
                    cnt += Time.deltaTime;
        ...
        else { if (cnt>0) { cnt-=Time.deltaTime;
            gaze.fillAmount=cnt/time;} }



        //-------------------------------------------------------------------------------------//
        //----------------------underpointer text controller-----------------------------------//
        if ( modified==true)
        {
